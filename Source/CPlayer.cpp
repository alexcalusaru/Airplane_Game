...
//       such as player movemenent, some minor physics as well as rendering.
//-------------------------------------------------------------------------
...
void CPlayer::RotatePlaneRight()
{
	...
	m_pSprite->SetImage("data/ship1R.bmp", RGB(0xff, 0x00, 0xff));
	dir = 1;
}
void CPlayer::RotatePlaneDown()
{

	m_pSprite->SetImage("data/ship1D.bmp", RGB(0xff, 0x00, 0xff));
	dir = 2;
}
void CPlayer::RotatePlaneLeft()
{
	m_pSprite->SetImage("data/ship1L.bmp", RGB(0xff, 0x00, 0xff));
...
{
	m_pSprite->SetImage("data/ship1.bmp", RGB(0xff, 0x00, 0xff));
